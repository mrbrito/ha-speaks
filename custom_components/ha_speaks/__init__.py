...
GROUP_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_ALEXA_NOTIFICATION_TYPE, default="announce"): vol.In(
            ["announce", "tts"]
        ),
...
SERVICE_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_ALEXA_NOTIFICATION_TYPE): vol.In(["announce", "tts"]),
...
def _build_announce_handler(hass: HomeAssistant):
    async def async_handle_announce(call: ServiceCall) -> None:
        ...
        alexa_notification_type: str | None = call.data.get(CONF_ALEXA_NOTIFICATION_TYPE)
        ...
        if group_name:
            ...
            alexa_notification_type = alexa_notification_type or group.get(
                CONF_ALEXA_NOTIFICATION_TYPE
            )
            alexa_targets.extend(group.get(CONF_ALEXA_TARGETS, []))

        alexa_notification_type = alexa_notification_type or "announce"
